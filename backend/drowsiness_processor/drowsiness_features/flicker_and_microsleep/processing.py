...
class FlickerReportGenerator(ReportGenerator):
    def generate_report(self, data: dict[str, bool | int | list]) -> Dict[str, Any]:
        ...
        return {
            ...
            'report_message': f'Counting flickers... {round(0.7 - elapsed_time, 2)} seconds remaining.',
    ...
    def process(self, eyes_distance: dict):
        ...
        if elapsed_time >= 1.0:
            flicker_data = {
                ...
                "flicker_report": self.flicker_counter.flicker_count >= 2,
        ...
        return {
            'flicker_count': f'Counting flickers... {round(1.0 - elapsed_time, 2)} seconds remaining.',
            'flicker_report': False,
            'micro_sleep_report': False
        }
